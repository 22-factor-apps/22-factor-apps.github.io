...
> **The litmus test:** take one user-visible failure and follow it across every process it touched. If that's a query over correlated, structured events, this factor holds; if it's grep folklore, it doesn't.
