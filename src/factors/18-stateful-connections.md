...
the balancer connection lifetimes so drains converge.

> **The litmus test:** kill any single process at peak. Clients should experience a
> reconnect blip, zero lost messages, and zero paged humans.
