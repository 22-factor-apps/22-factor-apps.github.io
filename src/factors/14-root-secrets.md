...
> **The litmus test:** enumerate every secret that exists outside version control. The right answer has one or two entries, all in the external service, all fetched via workload identity, all audited. Any more and the boundary needs redrawing.
