...
> **The litmus test:** `git describe` on the production deploy prints a tag that appears in your release notes, your registry, and your audit log — the same tag in all three.
