...
> **The litmus test:** run `git log --oneline --graph` on `main`. A clean sequence of reviewed decisions means history is an asset; tangled holiday lights add thirty minutes to every future incident.
