...
> **The litmus test:** pick a random merged PR from last month. A real question, a real answer, and a change made because of it means review is alive. "LGTM" eleven minutes into a 900-line diff means you have a merge queue with extra steps.
