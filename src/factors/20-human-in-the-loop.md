...
> **The litmus test:** list the actions a human must approve. Too long, and people are an error-correction layer for weak automation; empty, and an unattended process can destroy something you can't get back. Both are design failures.
